        ...
        <div className="grid gap-20 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
          ...
          <div ref={cards.ref} className="flex md:grid overflow-x-auto md:overflow-visible gap-6 snap-x snap-mandatory scrollbar-hide pb-12 md:pb-0 px-2 md:px-0">
            ...
            {(() => {
              ...
              return (
                <Link href={`/${toddy.slug}`} className="no-underline group shrink-0 w-[88vw] md:w-full snap-center self-start h-fit">
                  <article
                    className="border-8 border-kcc-gold bg-white p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[16px_16px_0px_0px_rgba(255,230,109,1)] relative overflow-hidden"
                    style={{
